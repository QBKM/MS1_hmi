...
#define OLED_RST(x)   HAL_GPIO_WritePin(SSD1351_NRST_GPIO_Port, SSD1351_NRST_Pin, x)
#define OLED_DC(x)    HAL_GPIO_WritePin(SSD1351_DC_GPIO_Port, SSD1351_DC_Pin, x)
#define OLED_CS(x)    HAL_GPIO_WritePin(SSD1351_NSS_GPIO_Port, SSD1351_NSS_Pin, x)
