...
static TF_Result id_parser_app_phase(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.APP.PHASE, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_app_window(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.APP.WINDOW, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_app_aeroc(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.APP.AEROC, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_mntr_bat_seq(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.MNTR.BAT_SEQ, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_mntr_bat_motor1(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.MNTR.BAT_MOTOR1, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_mntr_bat_motor2(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.MNTR.BAT_MOTOR2, (char*)(tf->data), strlen((char*)tf->data));
...
static TF_Result id_parser_recov_last_cmd(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.RECOVERY.LAST_CMD, (char*)(tf->data), strlen((char*)tf->data));
    return TF_STAY;
}
...
static TF_Result id_parser_recov_status(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.RECOVERY.STATUS, (char*)(tf->data), strlen((char*)tf->data));
    return TF_STAY;
}
...
static TF_Result id_parser_payload_last_cmd(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.PAYLOAD.LAST_CMD, (char*)(tf->data), strlen((char*)tf->data));
    return TF_STAY;
}
...
static TF_Result id_parser_payload_status(TinyFrame *tf, TF_Msg *msg)
{
    memcpy(uart_storage.PAYLOAD.STATUS, (char*)(tf->data), strlen((char*)tf->data));
    return TF_STAY;
}
