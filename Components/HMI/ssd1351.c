...
static void SSD1351_Select() {
    HAL_GPIO_WritePin(SSD1351_NSS_Pin, SSD1351_NSS_GPIO_Port, GPIO_PIN_RESET);
}

void SSD1351_Unselect() {
    HAL_GPIO_WritePin(SSD1351_NSS_Pin, SSD1351_NSS_GPIO_Port, GPIO_PIN_SET);
}

static void SSD1351_Reset() {
    HAL_GPIO_WritePin(SSD1351_NRST_GPIO_Port, SSD1351_NRST_Pin, GPIO_PIN_SET);
    HAL_Delay(500);
    HAL_GPIO_WritePin(SSD1351_NRST_GPIO_Port, SSD1351_NRST_Pin, GPIO_PIN_RESET);
    HAL_Delay(500);
    HAL_GPIO_WritePin(SSD1351_NRST_GPIO_Port, SSD1351_NRST_Pin, GPIO_PIN_SET);
    HAL_Delay(500);
}
